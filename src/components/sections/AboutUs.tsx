  ...
  return (
    <section id="about-us" className="bg-white py-20">
      <div className="mx-auto max-w-4xl px-6">
        ...
        <p className="mb-12 text-center text-base leading-relaxed text-ipe-green-900 md:text-justify">
          A Ipê - Educação Ambiental surge em solo amazônico, da união entre a expertise
          científica e a paixão pedagógica de duas pesquisadoras e educadoras. Com um olhar
          atento às urgências socioambientais, a empresa transforma o conhecimento acadêmico
          em soluções práticas, com o objetivo de multiplicar hábitos sustentáveis e
          regenerativos no cotidiano da sociedade. Nossa atuação é pautada pelo respeito aos
          ciclos naturais e pelo compromisso de formar cidadãos e instituições capazes de
          coexistir em equilíbrio com o meio ambiente.
        </p>
